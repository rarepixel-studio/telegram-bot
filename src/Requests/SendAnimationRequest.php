 ...
 */
class SendAnimationRequest extends TelegramApiRequest
{
    /**
     * {@inheritdoc}
     */
     ...
     * @param  InputFile|string  $animation  Animation to send. Pass a file_id as String to send an animation that exists on the Telegram servers (recommended), pass an HTTP URL as a String for Telegram to get an animation from the Internet, or upload a new animation using multipart/form-data.
     */
    ...
    /**
     * @param  ParseMode|string  $parse_mode  Mode for parsing entities in the animation caption.
     *
