...
/**
 * Request object for the getBusinessAccountStarBalance method.
 *
 * Use this method to get the value of the balance of Telegram Stars of the business connection.
 *
 * @link https://core.telegram.org/bots/api#getbusinessaccountstarbalance
 */
class GetBusinessAccountStarBalanceRequest extends TelegramApiRequest
{
    /**
