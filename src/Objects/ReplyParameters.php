 ...
 * @method string|null   getQuote()                     (Optional). Quoted part of the message to be replied to; 0-1024 characters after entities parsing. The quote must be an exact substring of the message to be replied to, including bold, italic, underline, strikethrough, spoiler, and custom_emoji entities.
 ...
 * @method array|null    getQuoteEntities()             (Optional). A JSON-serialized list of special entities that appear in the quote. It can be specified instead of quote_parse_mode.
 * @method int|null      getQuotePosition()             (Optional). Position of the quote in the original message in UTF-16 code units.
 */
class ReplyParameters extends BaseObject
{
    /**
