...
class SendMessage extends BaseObject
{
    ...
    protected ?ParseMode $parse_mode = null;
    ...
    /**
     * Get the parse mode for message entities.
     */
    public function getParseMode(): ?string
    {
        return $this->parse_mode?->value;
    }
     ...
     */
    public function setParseMode(ParseMode|string|null $parse_mode): void
    {
