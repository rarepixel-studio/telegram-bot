...
class GetChatMemberRequestTest extends TestCase
{
    public function test_it_validates_invalid_user_id()
    {
        ...
        $request = new GetChatMemberRequest(-100123456789, 0);
        $request->validate();
    }

    public function test_it_serializes_to_array_correctly()
    {
        $request = new GetChatMemberRequest(-100123456789, 12345);
    ...
    {
        $request = new GetChatMemberRequest(-100123456789, 12345);
        $this->assertEquals('getChatMember', $request->getMethod());
    }
}
