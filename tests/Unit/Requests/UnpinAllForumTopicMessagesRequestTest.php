...
class UnpinAllForumTopicMessagesRequestTest extends TestCase
{
    public function test_it_validates_invalid_message_thread_id()
    {
        ...
        $request = new UnpinAllForumTopicMessagesRequest(-100123456789, 0);
        $request->validate();
    }

    public function test_it_serializes_to_array_correctly()
    {
        $request = new UnpinAllForumTopicMessagesRequest(-100123456789, 123);
    ...
    {
        $request = new UnpinAllForumTopicMessagesRequest(-100123456789, 123);
        $this->assertEquals('unpinAllForumTopicMessages', $request->getMethod());
    }
}
