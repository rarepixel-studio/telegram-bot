...
class GetUserProfileAudiosRequestTest extends TestCase
{
    public function test_it_validates_invalid_user_id()
    {
        ...
        $request = new GetUserProfileAudiosRequest(0);
        $request->validate();
    }
    ...
    public function test_it_validates_negative_offset()
    {
        ...
        $request = new GetUserProfileAudiosRequest(12345);
        $request->offset(-1);
        $request->validate();
    }
    ...
    {
        $request = new GetUserProfileAudiosRequest(12345);
        $this->assertEquals('getUserProfileAudios', $request->getMethod());
    }
}
