...
class ApiTest extends TestCase
{
    ...
    {
        if (is_int($type)) {
            $this->markTestSkipped('PHP coerces int to string, so no exception is thrown for integers');
    ...
    /** @test */
    public function it_checks_a_user_object_is_returned_when_get_me_is_requested()
    {
    ...
    /** @test */
    public function it_checks_a_message_object_is_returned_when_send_message_is_sent()
    {
        $chatId = 987654321;
        $text = 'Test message';
        $this->api = Mocker::createApiResponse(
    ...
    /** @test */
    public function it_checks_a_message_object_is_returned_when_forward_message_is_sent()
    {
        $chatId = 987654321;
        $fromId = 888888888;
    ...
    /** @test */
    public function it_checks_a_message_object_is_returned_with_photo_information_when_send_photo_is_sent()
    {
        $chatId = 987654321;
     ...
     */
    public function it_checks_a_message_object_is_returned_with_correct_fields_when_all_file_types_are_attached_to_a_message(
        $fileType
    ) {
        $chatId = 987654321;
        $fileId = md5($fileType);
    ...
    /** @test */
    public function it_checks_a_message_object_is_returned_with_correct_fields_when_send_location_is_sent()
    {
        $chatId = 987654321;
     ...
     * @test
     */
    public function it_throws_exception_if_invalid_chat_action_is_sent()
    {
        $this->expectException(TelegramSDKException::class);
    ...
    /** @test */
    public function it_returns_a_successful_response_if_a_valid_chat_action_is_sent()
    {
    ...
    /** @test */
    public function it_returns_a_file_object_if_get_file_is_sent()
    {
        $fileId = md5('file_id');
        $this->api = Mocker::createApiResponse(
            [
    ...
    /** @test */
    public function it_returns_true_if_set_chat_photo_is_sent()
    {
        $fileId = md5('file_id');
        $this->api = Mocker::createApiResponse(true);
    ...
    /** @test */
    public function it_returns_true_if_create_new_sticker_set_is_sent()
    {
        $fileId = md5('file_id');
        $this->api = Mocker::createApiResponse(true);
    ...
    /** @test */
    public function it_returns_true_if_add_sticker_to_set_is_sent()
    {
        $fileId = md5('file_id');
        $this->api = Mocker::createApiResponse(true);
    ...
    /** @test */
    public function it_returns_a_file_object_if_upload_sticker_file_is_sent()
    {
        $fileId = md5('file_id');
        $this->api = Mocker::createApiResponse(
            [
     ...
     * @test
     */
    public function it_throws_an_exception_if_set_webhook_url_is_not_a_url()
    {
        $this->expectException(TelegramSDKException::class);
